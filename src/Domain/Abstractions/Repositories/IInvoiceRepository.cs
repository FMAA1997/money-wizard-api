...
public interface IInvoiceRepository : IRepository<InvoiceSeries>
{
    ...
    void DeleteException(InvoiceException exception);

    Task<InvoiceException?> GetException(Guid seriesId, DateOnly date, CancellationToken cancellationToken = default);
