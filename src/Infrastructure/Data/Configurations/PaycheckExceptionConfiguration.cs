...
public sealed class PaycheckExceptionConfiguration : IEntityTypeConfiguration<PaycheckException>
{
    public void Configure(EntityTypeBuilder<PaycheckException> builder)
    {
