...
public sealed class PaycheckSegmentConfiguration : IEntityTypeConfiguration<PaycheckSegment>
{
    public void Configure(EntityTypeBuilder<PaycheckSegment> builder)
    {
